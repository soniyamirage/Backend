...
from .views import SettingsCreateView
from .views import SettingsDetailView
from .views import SettingsUpdateView
from .views import SettingsDeleteView
from .views import EngineSubmoduleListView
from .views import EngineSubmoduleCreateView
from .views import EngineSubmoduleDetailView
from .views import EngineSubmoduleUpdateView
from .views import EngineSubmoduleDeleteView
from .views import EngineActivityListView
from .views import EngineActivityCreateView
from .views import EngineActivityDetailView     
from .views import EngineActivityUpdateView
from .views import EngineActivityDeleteView
from .views import EngineModuleListView
from .views import EngineModuleCreateView   
from .views import EngineModuleDetailView
from .views import EngineModuleUpdateView
from .views import EngineModuleDeleteView
from .views import SidebarMenuView, UserTypeListView
from .views import ClientListView, ClientCreateView, ClientDetailView, ClientUpdateView, ClientDeleteView
from .views import CouponListView, CouponCreateView, CouponGenerateCodeView, CouponValidateView, CouponUpdateView, CouponDeleteView
from .views import CountryCreateView, CountryListView, CountryDetailView, CountryUpdateView, CountryDeleteView
from .views import CityCreateView, CityListView, CityByStateView, CityDetailView, CityUpdateView, CityDeleteView
from .views import StateCreateView, StateListView, StateByCountryView, StateDetailView
from .views import StateDetailView
from .views import StateUpdateView, StateDeleteView
from .views import ModuleDropdownView, UrlDropdownView
from .views import ClientFollowupListView, ClientFollowupCreateView, ClientFollowupDetailView, ClientFollowupUpdateView, ClientFollowupDeleteView
from .views import AssociateListCreateView, AssociateDetailView
from .views import UserListCreateView, UserDetailView, UserProfileView
from .views import CinemaCreateView, CinemaListView, CinemaDetailView, CinemaUpdateView
from .views import CinemaDeleteView, CinemaFilterOptionsView
from .views import ContactCreateView
from .views import CartAddView, CartProcessView, CartCountView, CartDeleteView, WeeksListView, AdlengthsListView
from .views import MovieSliderListView,MovieSliderCreateView, MovieSliderUpdateView, MovieSliderDeleteView
from .views import CouponRequestListView, CouponRequestCreateView, CouponRequestDetailView, CouponRequestUpdateView, CouponRequestDeleteView
from .views import TopBrandsListView, TopBrandsCreateView, TopBrandUpdateView,TopBrandDeleteView
from .views import PartnerListView, PartnerCreateView, PartnerDetailView, PartnerUpdateView, PartnerDeleteView
from .views import PartnerBankDetailsListView, PartnerBankDetailsDetailView, PartnerBankDetailsCreateView, PartnerBankDetailsUpdateView, PartnerBankDetailsDeleteView
from .views import BookCampaignListView, BookCampaignDetailView 
from .views import ro
from .views import CustomerQueryListView, CustomerQueryCreateView, CustomerQueryDetailView,CustomerQueryUpdateView, CustomerQueryDeleteView
from .views import PartnerCinemaListView    
from .views import PartnerCartAddView, PartnerCartProcessView, PartnerCartDeleteView, PartnerCartCountView, PartnerCartItemsView
from .views import SendOTPView, VerifyOTPView, InitiatePaymentView, VerifyPaymentView, PaymentStatusListView, OfflinePaymentModesListView
from .views import CinemaFilterOptionsView
from .views import generate_quotation_api
from .views import generate_partner_quotation_api
...
urlpatterns = [
    ...
    path("api/admin-login/", loginUser, name="admin-login"),
    ...
    path('api/cart/delete/', CartDeleteView.as_view(), name='cart-delete'),
    ...
    path('api/topbrands/update/<int:id>/', TopBrandUpdateView.as_view()),
    path('api/topbrands/delete/', TopBrandDeleteView.as_view()), 
    ...
    path('api/p_plan_campaign/filters/', CinemaFilterOptionsView.as_view(), name='partner-filters'),
