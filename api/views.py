...
class BookCampaignDetailView(APIView):
    def get(self, request, id):
        return Response({"message": f"Campaign {id}"})

class BookCampaignUpdateView(APIView):
    def put(self, request, id):
        return Response({
            "message": f"Campaign {id} updated successfully"
        })

class BookCampaignDeleteView(APIView):
    def delete(self, request, id):
        return Response({
            "message": f"Campaign {id} deleted successfully"
        })

def ro(request, id):
    return HttpResponse(f"RO download for campaign {id}")
...
class CustomerQueryCreateView(APIView):
    def post(self, request):
        return Response({"message": "Customer query created successfully"})

class CustomerQueryDetailView(APIView):
    def get(self, request, id):
        return Response({"message": f"Customer query detail for {id}"})

class CustomerQueryUpdateView(APIView):
    def put(self, request, id):
        return Response({
            "message": f"Customer query {id} updated successfully"
        })

class CustomerQueryDeleteView(APIView):
    def delete(self, request, id):
        return Response({
            "message": f"Customer query {id} deleted successfully"
        })

class PartnerCinemaListView(APIView):
    def get(self, request):
        return Response({"partner_cinemas": []})

class PartnerCartAddView(APIView):
    def post(self, request):
        return Response({"message": "Partner cart item added"})

class PartnerCartListView(APIView):
    def get(self, request):
        return Response({"partner_cart": []})

class PartnerCartDetailView(APIView):
    def get(self, request, id):
        return Response({"message": f"Partner cart detail for {id}"})

class PartnerCartUpdateView(APIView):
    def put(self, request, id):
        return Response({
            "message": f"Partner cart {id} updated successfully"
        })

class PartnerCartDeleteView(APIView):
    def delete(self, request, id):
        return Response({
            "message": f"Partner cart {id} deleted successfully"
        })
...
class PartnerCartProcessView(APIView):
    def post(self, request):
        return Response({
            "message": "Partner cart processed successfully"
        })
...
class PartnerRODownloadView(APIView):
    def get(self, request, campaign_code):
        return Response({
            "message": f"RO download for campaign {campaign_code}"
        })

class PartnerGenerateQuotationView(APIView):
    def post(self, request):
        return Response({"message": "Quotation generated successfully"})

class PartnerGeneratePartnerQuotationView(APIView):
    def post(self, request):
        return Response({"message": "Partner quotation generated successfully"})

class PartnerDashboardStatsView(APIView):
    def get(self, request):
        return Response({"message": "Dashboard stats working"})
...
class PartnerCartItemDeleteView(APIView):
    def delete(self, request, id):
        return Response({
            "message": f"Partner cart item {id} deleted successfully"
        })

class PartnerCartItemUpdateView(APIView):
    def put(self, request, id):
        return Response({
            "message": f"Partner cart item {id} updated successfully"
        })

class PartnerCartItemCreateView(APIView):
    def post(self, request):
        return Response({
            "message": "Partner cart item created successfully"
        })
...
class PaymentStatusListView(APIView):
    def get(self, request):
        return Response({
            "statuses": [
                "pending",
...
class OfflinePaymentModesListView(APIView):
    def get(self, request):
        return Response({
            "modes": [
                "cash",
...
def generate_partner_quotation_api(request):
    return JsonResponse({
        "message": "Partner quotation generated successfully",
        "total_amount": 0,
        "items": []
    })
